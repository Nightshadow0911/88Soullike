...
public class BossDeathBringerEnemy : EnemyCharacter
{
    private Boss_DeathBringerStat uniqueStats; //유닛 스탯 연결
    private RangedAttack rangedAttack; //원거리 공격?
    private PositionAttack positionAttack; //좌표 공격?

    [Header("Unique Setting")]
    [SerializeField] private LayerMask tileLayer; //충돌할 레이어 설정
    private bool isRage = false; //분노 상태 bool값 설정
